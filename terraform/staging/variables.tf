...
variable "tailor_server_secrets" {
  ...
  default = {
    ...
    PREVIEW_URL                    = "arn:aws:ssm:us-east-1:902864695929:parameter/cepp-tailor/staging/PREVIEW_URL"
    PROTOCOL                       = "arn:aws:ssm:us-east-1:902864695929:parameter/cepp-tailor/staging/PROTOCOL"
    REVERSE_PROXY_PORT             = "arn:aws:ssm:us-east-1:902864695929:parameter/cepp-tailor/staging/REVERSE_PROXY_PORT"
