...
variable "tailor_server_secrets" {
  ...
  type        = map(string)
  default = {
    AUTH_JWT_SECRET           = "arn:aws:ssm:us-east-1:902864695929:parameter/appr/tailor/staging/AUTH_JWT_SECRET"
    EMAIL_PASSWORD            = "arn:aws:ssm:us-east-1:902864695929:parameter/appr/tailor/staging/EMAIL_PASSWORD"
    EMAIL_USER                = "arn:aws:ssm:us-east-1:902864695929:parameter/appr/tailor/staging/EMAIL_USER"
    OIDC_CLIENT_ID            = "arn:aws:ssm:us-east-1:902864695929:parameter/appr/tailor/staging/OIDC_CLIENT_ID"
    OIDC_CLIENT_SECRET        = "arn:aws:ssm:us-east-1:902864695929:parameter/appr/tailor/staging/OIDC_CLIENT_SECRET"
